...
public class JedisUtil {
    ...
    public static long setObjectList(String key, List<Object> value, int cacheSeconds) {
        ...
        try {
            ...
            List<byte[]> list = CollectionUtil.createArrayList();
            for (Object o : value){
    ...
    public static long setMapList(String key, ArrayList<Map<String,String>> value, int cacheSeconds) {
        long result = 0;
        Jedis jedis = null;
        try {
            jedis = jedisPool.getResource();
    ...
    public static Set<Object> getObjectSet(String key) {
        ...
        try {
            jedis = jedisPool.getResource();
            if (jedis.exists(JSON.toJSONBytes(key))) {
                value = CollectionUtil.createArrayHashSet();
    ...
    public static long setObjectSet(String key, Set<Object> value, int cacheSeconds) {
        ...
        try {
            ...
            Set<byte[]> set = CollectionUtil.createArrayHashSet();
            for (Object o : value){
    ...
    public static Map<String, Object> getObjectMap(String key) {
        ...
        try {
            jedis = jedisPool.getResource();
            if (jedis.exists(JSON.toJSONBytes(key))) {
                value = CollectionUtil.createArrayHashMap();
                Map<byte[], byte[]> map = jedis.hgetAll(JSON.toJSONBytes(key));
                for (Map.Entry<byte[], byte[]> e : map.entrySet()){
                    value.put(String.valueOf(e.getKey()), JSON.parseObject(((JSONObject) JSON.parse(e.getValue())).toString(), HashMap.class));
                }
    ...
    public static String setObjectMap(String key, Map<String, Object> value, int cacheSeconds) {
        ...
        try {
            ...
            Map<byte[], byte[]> map = CollectionUtil.createArrayHashMap();
